...
=========================================
Testing
See tests/test_cases.md for the full list of manual test cases covering valid input, duplicate IDs, invalid categorical values, empty inventory, search misses, update/delete on non-existent IDs, and persistence across runs.
